...
public class DoorLiftTrigger : MonoBehaviour
{
	...
	private CameraOverheadFollow camMovement;				// Reference to the camera movement script.
	private SceneFadeInOut sceneFadeInOut;			// Reference to the SceneFadeInOut script.
	private ElevatorDoorsTracking liftDoorsTracking;	// Reference to LiftDoorsTracking script.
	...
	void Awake ()
	{
		...
		camMovement = Camera.main.gameObject.GetComponent<CameraOverheadFollow>();
		sceneFadeInOut = GameObject.FindGameObjectWithTag(InGameTags.fader).GetComponent<SceneFadeInOut>();
		liftDoorsTracking = GetComponent<ElevatorDoorsTracking>();
	}
